        ...
        <div className="bg-[#283046] p-4 rounded-md">
          ...
          <form onSubmit={submit}>
            <div className="flex flex-col w-full gap-1 mb-3">
              <label htmlFor="Input your name">Name</label>
              <input
            ...
            <div className="flex flex-col w-full gap-1 mb-3">
              <label htmlFor="Input your name">Email</label>
              <input
                onChange={inputHandle}
                value={state.email}
                className="px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden"
            ...
            <div className="flex flex-col w-full gap-1 mb-3">
              <label htmlFor="Input your name">Password</label>
              <input
                onChange={inputHandle}
            ...
            <div className="flex justify-center items-center gap-3">
              ...
              <div className="w-[35px] h-[35px] flex rounded-md bg-indigo-700 shadow-lg hover:shadow-indigo-700/50 justify-center items-center cursor-pointer overflow-hidden">
                <span>
                  <FiFacebook />
                </span>
              </div>
